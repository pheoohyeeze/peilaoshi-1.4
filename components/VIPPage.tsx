...
const VIPPage: React.FC<VIPPageProps> = ({ onClose, onPurchaseClick, onShowTutorial }) => {
  return (
    ...
    >
      <div
        className="relative w-full max-w-sm rounded-3xl bg-gradient-to-b from-teal-400 to-teal-600 text-white shadow-2xl animate-fade-in flex flex-col max-h-[90vh]"
